...
namespace SETUtil
{
	...
	public static class EditorUtil
	{
		...
		private static TimedList<iGUIElement> guiQueue = new TimedList<iGUIElement>();
		...
		private static void SubGUIDelegate()
		{
			...
			E.SceneView.duringSceneGui -= DrawQueuedSceneGUI;
			E.SceneView.duringSceneGui += DrawQueuedSceneGUI;
#elif UNITY_EDITOR
		...
		public static void ClearSceneGUI()
		{
			UnsubGUIDelegate();
			AgeQueueIterator();
			guiQueue = new TimedList<iGUIElement>();
		}
